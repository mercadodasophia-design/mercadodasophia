...
class AdminBannersLojaScreen extends StatefulWidget {
  const AdminBannersLojaScreen({super.key});

  @override
  State<AdminBannersLojaScreen> createState() => _AdminBannersLojaScreenState();
}

class _AdminBannersLojaScreenState extends State<AdminBannersLojaScreen> {
  ...
  Future<void> _loadBanners() async {
    ...
    try {
      final banners = await _bannerService.getLojaBanners();
      setState(() {
        _banners = banners;
        _isLoading = false;
      });
